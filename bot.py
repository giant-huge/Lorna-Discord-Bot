...
async def play(ctx, url : str):
    ...
    try:
        ...
        await ctx.send('Wait your turn love.')
        return
...
async def leave(ctx):
    ...
    if voice.is_connected():
        ...
        await ctx.send('Love, I am not in the Music channel.')
...
async def pause(ctx):
    ...
    if voice.is_playing():
        ...
        await ctx.send('No tunes jammin right now love.')
...
async def resume(ctx):
    ...
    if voice.is_paused():
        ...
        await ctx.send('Me stereo is not paused.')
